...
public class Clone_Trees_1485 {
    public static void main(String[] args) {
        ...
        root.right.random = new Node(7);
        root.right.left = root.right.random;
        root.right.right = null;

        root.right.random.random = root;
    ...
    static HashMap <Node , NodeCopy> map;
